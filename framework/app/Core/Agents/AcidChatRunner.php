...
final class AcidChatRunner
{
    ...
    private function defaultTests(): array
    {
        return [
            ...
            ['msg' => 'dame el estado del proyecto', 'expect' => ['respond_local'], 'contains' => 'Estado del proyecto'],
            ...
            ['msg' => 'crear formulario clientes', 'mode' => 'builder', 'expect' => ['execute_command'], 'command' => 'CreateForm'],
            ['msg' => 'crear producto', 'mode' => 'app', 'expect' => ['respond_local'], 'contains' => 'creador'],
            ['msg' => 'crear producto', 'mode' => 'builder', 'expect' => ['ask_user'], 'contains' => 'crear tabla'],
            ['msg' => 'crear cliente nombre=Juan nit=123', 'expect' => ['execute_command'], 'command' => 'CreateRecord'],
            ['msg' => 'listar cliente', 'expect' => ['execute_command'], 'command' => 'QueryRecords'],
            ['msg' => 'actualizar cliente id=1 email=juan@mail.com', 'expect' => ['execute_command'], 'command' => 'UpdateRecord'],
            ['msg' => 'eliminar cliente id=1', 'expect' => ['execute_command'], 'command' => 'DeleteRecord'],
            ...
            ['msg' => 'que hay hecho', 'expect' => ['respond_local'], 'contains' => 'Estado del proyecto'],
