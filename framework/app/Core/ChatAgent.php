...
use App\Core\Telemetry\AgentOpsTelemetryBuilder;
...
final class ChatAgent
{
    ...
    private function telemetryBuilder(): AgentOpsTelemetryBuilder
    {
        return $this->telemetryBuilder ??= new AgentOpsTelemetryBuilder(
            $this->agentOpsSupervisor(),
            $this->agentOpsObservabilityService()
        );
    }
    ...
    private function buildLocalUtilityTelemetry(
        ...
        return $this->attachControlTowerTelemetry([
            ...
            'contract_versions' => $this->telemetryBuilder()->resolveExtendedContractVersions(),
        ], $task, $conversationId);
    }
    ...
    private function rememberAgentOpsTrace(
        ...
        $runtimeObservability = $this->telemetryBuilder()->buildAgentOpsRuntimeObservability($routeTelemetry, $latencyMs, $runtimeContext);
        ...
        try {
            $this->agentOpsObservabilityService()->recordDecisionTrace([
                ...
                'selected_module' => $this->telemetryBuilder()->resolveDecisionSelectedModule($runtimeObservability),
                'selected_action' => $this->telemetryBuilder()->resolveDecisionSelectedAction($runtimeObservability),
                'evidence_source' => $this->telemetryBuilder()->resolveDecisionEvidenceSource($runtimeObservability),
                ...
                'result_status' => $this->telemetryBuilder()->resolveDecisionResultStatus($runtimeObservability),
                'metadata_json' => [
