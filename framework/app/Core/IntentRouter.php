...
final class IntentRouter
{
    ...
    private function mapCommandToCatalogAction(string $commandName): string
    {
        ...
        $map = [
            ...
            'LinkEcommerceOrder' => 'ecommerce.link_order',
            'GetEcommerceOrderLink' => 'ecommerce.get_order_link',
            'ListEcommerceOrderLinks' => 'ecommerce.list_order_links',
            'RegisterEcommerceOrderPullSnapshot' => 'ecommerce.register_order_pull_snapshot',
            'NormalizeEcommerceExternalOrder' => 'ecommerce.normalize_external_order',
            'MarkEcommerceOrderSyncStatus' => 'ecommerce.mark_order_sync_status',
            'GetEcommerceOrderSnapshot' => 'ecommerce.get_order_snapshot',
            'LinkEcommerceProduct' => 'ecommerce.link_product',
            'UnlinkEcommerceProduct' => 'ecommerce.unlink_product',
            'ListEcommerceProductLinks' => 'ecommerce.list_product_links',
            'GetEcommerceProductLink' => 'ecommerce.get_product_link',
            ...
            'TenantAssignPlan' => 'saas.assign_plan',
            'TenantGetPlan' => 'saas.get_plan',
            'TenantListPlans' => 'saas.list_plans',
