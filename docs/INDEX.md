...
Bienvenido a la documentación centralizada de SUKI (AI-AOS). Toda la autoridad de diseño y registro histórico se encuentra en esta carpeta.

## 1. Gobernanza y Cánon (`/docs/canon/`)
*Leyes inmutables y contratos de arquitectura.*
- [TEXT_OS_ARCHITECTURE](file:///c:/laragon/www/suki/docs/canon/TEXT_OS_ARCHITECTURE.md)
...
- [**PROJECT_MEMORY (Fuente de Verdad)**](file:///c:/laragon/www/suki/docs/PROJECT_MEMORY.md)
- [PROJECT_MEMORY_CANONICAL](file:///c:/laragon/www/suki/docs/memory/PROJECT_MEMORY_CANONICAL.md)
- [08_WORK_PLAN](file:///c:/laragon/www/suki/docs/memory/08_WORK_PLAN.md)
- [HOSTING_MIGRATION_PLAN](file:///c:/laragon/www/suki/docs/memory/HOSTING_MIGRATION_PLAN.md)
...
---
> [!NOTE]
> Esta estructura ha sido unificada el 2026-03-29 para centralizar la memoria del sistema y facilitar la navegación de agentes y desarrolladores.
